...
values."
  (setq-default
   ...
   ;git clone https://github.com/syl20bnr/spacemacs ~/.emacs.d; or `spacemacs'. (default 'spacemacs)
...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Ricty Diminished Discord for Powerline"
                               ;; "Ricty Diminished" ;; "Source Code Pro"
                               :size 18
                               :weight normal
                               :width normal
                               :powerline-scale 1.1)
...
you should place your code here."
  ...
  (global-set-key (kbd "\C-c \C-b") 'cua-set-rectangle-mark)
  ...
  (add-hook 'c++-mode-hook 'my-c-c++-mode-init)
  (add-hook 'd-mode-hook 'my-c-c++-mode-init)
